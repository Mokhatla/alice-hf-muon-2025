...
*/
    ...
    if(local) {
        ...
        alienHandler->SetGridDataDir("/alice/sim/2018/LHC18j3");
        alienHandler->SetDataPattern("AOD209/*/AliAOD.Muons.root");
    ...
    //   "root_archive.zip:pyxsec_hists.root,AnalysisResults.root@disk=2"};
        ...
        alienHandler->SetGridWorkingDir("LHC18j3_JUN2024_v2");
