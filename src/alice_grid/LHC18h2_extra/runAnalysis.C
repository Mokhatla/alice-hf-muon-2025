...
*/
    ...
    if(local) {
        ...
        // select the input data
         alienHandler->SetGridDataDir("/alice/sim/2018/LHC18h2_extra"); // pythia6 perugia2011
       ...
       // alienHandler->AddRunNumber(244340);
        Int_t totruns=0;
        totruns += AddGoodRuns(alienHandler,"LHC18f"); // specify LHC period
    ...
    //   "root_archive.zip:pyxsec_hists.root,AnalysisResults.root@disk=2"};
        ...
        alienHandler->SetGridWorkingDir("LHC18h2_extra_JUN2024");
