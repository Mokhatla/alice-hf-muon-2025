...
*/
    ...
    if(local) {
        ...
        // alienHandler->SetGridDataDir("/alice/sim/2016/LHC16k5a"); // pythia8, pass3
       ...
       // alienHandler->AddRunNumber(244340);
        Int_t totruns=0;
        totruns += AddGoodRuns(alienHandler,"LHC15n"); // specify LHC period
        ...
        /// Define the output archive to include the desired ROOT files
        // "pyxsec_hists.root" and "AnalysisResults.root" will be stored under disk=2
        ...
        alienHandler->SetGridWorkingDir("LHC16k5b_JUN2024_v3");
